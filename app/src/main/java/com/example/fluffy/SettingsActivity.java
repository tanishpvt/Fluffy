...
public class SettingsActivity extends AppCompatActivity {
    ...
    //use shared prefrences to save the state of switch
    SharedPreferences sp;
    SharedPreferences.Editor editor; //to edit value of shared pref

    //constant for topic
    private static final String TOPIC_POST_NOTIFICATION = "POST";// assign any value but use same for kind of notification
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if enabled check switch switch, otherwise uncheck sswitch by default unchecked/false
        if (isPostEnabled){
    ...
    private void subscribePostNotification() {
        //subscribe to a topic (POST) to disable its notification
